...
In the [previous post]({filename}2026_02_26_rbw-bitwarden.en.md) we talked about **rbw**, the Bitwarden CLI client written in Rust that stands out for its speed and for using an agent to manage vault unlocking.
